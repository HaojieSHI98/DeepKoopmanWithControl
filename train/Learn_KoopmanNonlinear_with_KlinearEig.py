...
def train(env_name,train_steps = 200000,suffix="",all_loss=0,\
    ...
    best_loss = 1000.0
    best_state_dict = {}
    logdir = "../Data/"+suffix+"/KoopmanNonlinear_"+env_name+"layer{}_edim{}_eloss{}_gamma{}_aloss{}_detach{}_bdim{}".format(layer_depth,encode_dim,e_loss,gamma,all_loss,detach,b_dim)
